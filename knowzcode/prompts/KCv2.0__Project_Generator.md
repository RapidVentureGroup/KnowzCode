# KnowzCode v2.0 - Project Overview Generation Guide

**Version:** 2.0
**Date:** 2025-06-10
**Target Audience:** KnowzCode Orchestrator (to guide the AI Agent)

> **Automation Path:** Use `/kc-plan plan=project-generator` to prime the `planning-strategist` subagent with the existing backlog and state.
**Purpose:** This document guides the AI Agent to generate the complete Markdown content for a new `knowzcode_project.md` file. This file is a foundational core operational artifact in the KnowzCode v2.0 system, providing essential high-level context for the project.

---

**When this Guide is Used:**
*   During the initial setup of a new project, to create the `knowzcode_project.md` file from a high-level user idea.
...
5.  **Generate Output:** Your final output is **ONLY** the complete Markdown content intended for the `knowzcode_project.md` file.

---
## `knowzcode_project.md` Content Structure (Agent to Generate All Sections):

# Project Overview: [Agent: Infer a Project Name from UserProjectIdea]

**KnowzCode Version:** 2.0
**Document Version:** 1.0
**Creation Date:** 2025-06-10
**Last Updated:** 2025-06-10
**Author/Generator:** AI-Agent (guided by KnowzCode v2.0)
...
* **Key Components & Interactions (Brief Textual Description):** [Agent: Describe the main pieces and how they generally communicate. This complements `knowzcode/knowzcode_architecture.md`. E.g., "The React frontend client makes API calls to the Express.js backend. The backend handles business logic and interacts with the PostgreSQL database via Prisma ORM."]
*   **Diagram (Mermaid - Agent to Generate):**
    ...
    ```
    *(Agent: Generate a SIMPLE Mermaid diagram showing 2-5 main components and their primary interactions. The main detailed flowchart is in `knowzcode/knowzcode_architecture.md`.)*
...
### 18. Links to Other KnowzCode v2.0 Artifacts
