...
2.  **Review & Plan:**
    ...
    *   Review its spec at `knowzcode/specs/[TargetNodeID].md`, paying close attention to the `ARC Verification Criteria`. These are your success metrics.
