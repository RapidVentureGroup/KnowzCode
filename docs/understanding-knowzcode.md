...
**Always Begin With:** `knowzcode/prompts/KCv2.0__Start_Work_Session.md`
...
*Prompt:* `knowzcode/prompts/KCv2.0__[LOOP_1A]__Propose_Change_Set.md`
...
*Prompt:* `knowzcode/prompts/KCv2.0__[LOOP_1B]__Draft_Specs.md`
...
*Prompt:* `knowzcode/prompts/KCv2.0__Spec_Verification_Checkpoint.md`
...
*Prompt:* `knowzcode/prompts/KCv2.0__[LOOP_2A]__Implement_Change_Set.md`
...
*Prompt:* `knowzcode/prompts/KCv2.0__[LOOP_2B]__Verify_Implementation.md`
...
*Prompt:* `knowzcode/prompts/KCv2.0__[LOOP_3]__Finalize_And_Commit.md`
...
The `knowzcode/planning/` directory is where strategic analysis happens before code begins. It's your project's "think tank" powered by specialized prompts.
...
You use: `knowzcode/prompts/KCv2.0__Feature_Idea_Breakdown.md`
...
- **`knowzcode/prompts/KCv2.0__Pre_Flight_Feature_Analysis.md`** - Deep dive into ONE specific feature before building
- **`knowzcode/prompts/KCv2.0__Major_Mid_Project_Feature_Addition.md`** - When adding big features to existing projects
